 ...
 *
 * Real adapter — backs the unit tier and doubles as the fake substituted for the
 * Mongoose adapter under a Nest DI override in tests. Shares the
 * `runRuleRepositoryContract` suite with the Mongoose adapter (ADR-0014).
 *
