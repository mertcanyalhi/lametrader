 ...
 * satisfy.
 *
 * Run against the in-memory adapter in the unit tier and the Mongoose adapter
 * over a real Mongo (Testcontainers) in the e2e tier — together they prove the
 * Mongoose rewrite is behaviour-identical to the old native-driver
 * `MongoEventLog` (ADR-0014).
 *
