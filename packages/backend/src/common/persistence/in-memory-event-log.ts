 ...
 * substituted for the Mongoose adapter under a Nest DI override in tests. Shares
 * the event-log contract suite with the Mongoose adapter (ADR-0014). Relocated
 * verbatim from the engine's `InMemoryEventLog`.
 */
