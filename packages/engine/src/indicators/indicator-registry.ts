 ...
 *
 * Constructed at the composition root (see `defaultIndicators`) and passed via DI to anything that needs to look an indicator up — there is no module-level singleton.
 *
