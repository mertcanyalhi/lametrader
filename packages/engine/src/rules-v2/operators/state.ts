import { RulesV2, type StateValue } from '@lametrader/core';
 ...
 */
export function evaluateState(leaf: RulesV2.StateLeafCondition, ctx: EvaluationContext): boolean {
