...
export function evaluateChannel(
  ...
  if (leaf.operator === RulesV2.ChannelOperator.EnteringChannel && !currentStrictlyInside) {
    return false;
  }
  if (leaf.operator === RulesV2.ChannelOperator.ExitingChannel && !currentStrictlyOutside) {
    return false;
  }
