...
If you need an interview pass first, use `/interview-and-document` and come back here.

Triage labels are defined in [docs/triage/labels.md](../../docs/triage/labels.md).
...
3. Write the PRD using the template below, then publish it to the project issue tracker.
   Apply the `ready-for-agent` label — no need for additional triage.
